                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-icon position-absolute">
                                @foreach ($labels as $label )
                                  <input value="{{ $label->label_name  }}" class="checkoption2" name="labels" type="checkbox"  {{ old('labels') == 'Bug' ? 'checked' : '' }}  >
                                  <label for="javascript">{{ $label->id  }}</label>
                             @endforeach
                                @error('labels')
                                    <span class="alert-danger">{{ $message }}</span>
                                @enderror
                     ...
                     <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @foreach ($categories  as $category )
                                ...
                                <label for="javascript">{{ $category->id }}</label>  
                            @endforeach
                                 @error('categories')
                                    <span class="alert-danger">{{ $message }}</span>
                                @enderror
