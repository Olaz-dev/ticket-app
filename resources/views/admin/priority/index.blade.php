                            ...
                            <div class="col-12 mt-4">
                                <div class="table-responsive shadow rounded">
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>
                                                <th class="border-bottom p-3">Priority Number</th>
                                                <th class="text-center border-bottom p-3">Priority Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($priorities as $priority )
                                                ...
                                                <td class="text-center p-3">{{ $priority->priority_name }}</td>
                                                ...
                                                <td class="text-end p-3">
                                                    <a href="{{ route('priority.edit', $priority) }}" class="btn btn-sm btn-primary">Edit</a>
