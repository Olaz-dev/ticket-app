        ...
        <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{ ucfirst(Request::path() )}} List</h5>
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item text-capitalize"><a href="index.html">Landrick</a></li>
                                    <li class="breadcrumb-item text-capitalize"><a href="#">{{ Request::path() }}</a></li>
                                    <li class="breadcrumb-item text-capitalize active" aria-current="page">List</li>
                                </ul>
                            </nav>
                            <a href="{{ url('label/create') }}" class="btn btn-sm btn-primary">Add New Label</a>
                        </div>
                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($labels as $label )
                                                ...
                                                <td class="text-center p-3">{{ $label->label_name }}</td>
                                                ...
                                                <td class="text-end p-3">
                                                    <a href="{{ route('label.edit', $label) }}" class="btn btn-sm btn-primary">Edit</a>
