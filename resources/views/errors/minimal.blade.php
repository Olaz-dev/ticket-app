...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>@yield('code') -{{ config('app.name','Ticket App') }}</title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12 text-center">
                        ...
                        <div class="text-uppercase mt-4 display-5 fw-semibold">@yield('message')</div>
                        <div class="text-capitalize text-dark mb-4 error-page"></div>
                        <p class="text-muted para-desc mx-auto">Click Return Home</p>
                    </div><!--end col-->
                </div><!--end row-->
